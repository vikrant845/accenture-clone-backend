...
type ResolverFn<TOutput extends Record<string, unknown> | void, TParams extends AnyParams> = (opts: ResolverOptions<TParams>) => MaybePromise<TOutput>;
...
export interface UploadBuilder<TParams extends AnyParams> {
    ...
    onUploadComplete: <TOutput extends Record<string, unknown> | void>(fn: ResolverFn<TOutput, TParams>) => Uploader<{
        _input: TParams["_input"];
        _metadata: TParams["_metadata"];
        _middlewareArgs: TParams["_middlewareArgs"];
        _errorShape: TParams["_errorShape"];
...
export type inferEndpointOutput<TUploader extends Uploader<any>> = TUploader["_def"]["_output"] extends UnsetMarker ? undefined : TUploader["_def"]["_output"];
